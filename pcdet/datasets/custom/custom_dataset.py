...
class CustomDataset(DatasetTemplate):
    ...
    def get_lidar(self, idx):
        ...
        assert(lidar_file.exists(), f"{idx} missing") #assert lidar_file.exists()
    ...
    def get_infos(self, class_names, num_workers=4, has_label=True, sample_id_list=None, num_features=4):
        ...
        def process_single_scene(sample_idx):
            ...
            #print(has_label)
            #print(annotations['gt_boxes_lidar'].exists())

            if has_label:
                annotations = {}
                gt_boxes_lidar, name = self.get_label(sample_idx)
                if gt_boxes_lidar.tolist():
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 2 and sys.argv[1] == 'create_custom_infos':
        import yaml
        ...
        create_custom_infos(
            ...
            data_path=ROOT_DIR / 'data' / sys.argv[3],
            save_path=ROOT_DIR / 'data' / sys.argv[3],
        )
